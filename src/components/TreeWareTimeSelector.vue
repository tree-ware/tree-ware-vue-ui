      ...
      <vs-dropdown :disabled="this.disabled">
        ...
        <vs-dropdown-menu>
          ...
          <vs-dropdown-group vs-label="Minutes">
            <vs-dropdown-item @click="setMinutesAgo(10)"
              >10 minutes ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setMinutesAgo(20)"
              >20 minutes ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setMinutesAgo(40)"
              >40 minutes ago</vs-dropdown-item
            >
          </vs-dropdown-group>

          <vs-dropdown-group vs-label="Hours">
            <vs-dropdown-item @click="setHoursAgo(1)"
              >1 hour ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setHoursAgo(2)"
              >2 hours ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setHoursAgo(4)"
              >4 hours ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setHoursAgo(8)"
              >8 hours ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setHoursAgo(16)"
              >16 hours ago</vs-dropdown-item
            >
          </vs-dropdown-group>

          <vs-dropdown-group vs-label="Days">
            <vs-dropdown-item @click="setDaysAgo(1)"
              >1 day ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setDaysAgo(2)"
              >2 days ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setDaysAgo(4)"
              >4 days ago</vs-dropdown-item
            >
            <vs-dropdown-item @click="setDaysAgo(7)"
              >7 days ago</vs-dropdown-item
            >
          </vs-dropdown-group>
        </vs-dropdown-menu>
      </vs-dropdown>
